...
3.Create a folder named as docapi in webapps folder of installed tomcat and paste the  provided application into it.In my case the path is (C:\tomcat9\webapps\docapi).
